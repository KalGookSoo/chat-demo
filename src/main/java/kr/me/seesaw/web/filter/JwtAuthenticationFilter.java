package kr.me.seesaw.web.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authorizationHeader == null) {
            handleAuthenticationException(response, "Authorization header가 존재하지 않습니다.");
            return;
        }
        if (!authorizationHeader.startsWith("Bearer ")) {
            handleAuthenticationException(response, "Bearer 토큰 형식이 아닙니다.");
            return;
        }
    ...
    private void handleAuthenticationException(@NonNull HttpServletResponse response, String message) throws IOException {
